...
def getData():
    ...
    features = new_df.loc[:, new_df.columns != 'nt_geral_categoria_2_60']
    new_df.drop( ['nt_geral_categoria_2', 'nt_geral_categoria_3', 'nt_geral_categoria_5'], axis=1, inplace=True)
    

    X = features
    y = new_df['nt_geral_categoria_2_60'] #variavel alvo
...
def main():
    ...
    for i in classificadores:
        ...
        saveConfusion(confusion_matrix(y, y_pred, labels=[1,2]), nome_modelo+'_2_60', y, y_pred)
