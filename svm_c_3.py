...
def getData():
    ...
    new_df.drop( ['nt_geral_categoria_2', 'nt_geral_categoria_2_60', 'nt_geral_categoria_5'], axis=1, inplace=True)
...
def main():
    ...
    for i in classificadores:
        ...
        saveConfusion(confusion_matrix(y, y_pred, labels=[1,2,3]), nome_modelo+'_3', y, y_pred)
